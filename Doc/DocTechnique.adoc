...
image::images/DT_03_hierarchy_ar_session_xr_origin.png[title="Hiérarchie Scène : AR Session et XR Origin",width=900]

image::images/DT_04_main_camera_alpha0_components.png[width=900]

image::images/ARManager.png[title="Inspector Camera : Background Alpha 0 + AR Camera Manager",width=900]
