    ...
    private void ShowTabletStep()
    {
        ...
        switch (tabletCurrentStep)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                tabletTutorialTMP.text = "En cliquant dessus, tu peux choisir une position précise avec le curseur puis valider.";
            ...
            case 5:
                ...
                break;
            case 6:
                tabletTutorialTMP.text = "Ici, tu peux choisir comment afficher les mesures : par segments ou par sphères.";
                railPanel.SetActive(false);
